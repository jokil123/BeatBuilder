...
public class PlayManager implements GameAction {
...
//    }
    ...
    public void play() {
        songManager.playing = true;
    }

    public void pause() {
        songManager.playing = false;
    }
    ...
    public class BeatServer {
        ...
        public void reset() {
            tracks.forEach(track -> {
                track.notes.forEach(note -> note.setStatus(NoteStatus.NOT_PLAYED));
            });
        }
    }
